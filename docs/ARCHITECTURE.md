...
- **18.117 líneas** en `src/` (68 módulos), **11.016** en `tests/` (88 ficheros, 1146 tests).
...
**1146 tests en 8,8 segundos**, sin red ni base real. Cada detector tiene sus casos positivos y
