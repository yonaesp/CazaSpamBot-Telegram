...
- **18.117 líneas** en `src/` (68 módulos), **11.016** en `tests/` (97 ficheros, 1450 tests).
...
**1450 tests en 8,3 segundos**, sin red ni base real. Cada detector tiene sus casos positivos y
