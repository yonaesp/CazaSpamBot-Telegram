...
- **18.117 líneas** en `src/` (68 módulos), **11.016** en `tests/` (87 ficheros, 1137 tests).
...
**1137 tests en 9,2 segundos**, sin red ni base real. Cada detector tiene sus casos positivos y
