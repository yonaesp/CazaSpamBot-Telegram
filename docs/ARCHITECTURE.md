...
- **18.117 líneas** en `src/` (68 módulos), **11.016** en `tests/` (95 ficheros, 1370 tests).
...
**1370 tests en 8,3 segundos**, sin red ni base real. Cada detector tiene sus casos positivos y
