...
- **18.117 líneas** en `src/` (68 módulos), **11.016** en `tests/` (89 ficheros, 1182 tests).
...
**1182 tests en 8,3 segundos**, sin red ni base real. Cada detector tiene sus casos positivos y
