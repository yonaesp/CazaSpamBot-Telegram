...
- **21.526 líneas** en `src/` (77 módulos), **15.862** en `tests/` (112 ficheros, 1540 tests).
...
**1540 tests en 8,3 segundos**, sin red ni base real. Cada detector tiene sus casos positivos y
